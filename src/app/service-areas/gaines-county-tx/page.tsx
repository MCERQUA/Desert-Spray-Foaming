...
const areasServed = [
  ...
  "Loop",
  "Cedar Lake",
  "Hobbs (New Mexico border)",
];

export default function GainesCountyPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/commercial-spray-foam-insulation-metal-building.jpg"
            alt="Spray foam insulation in Gaines County TX"
            fill
        ...
        <div className="container mx-auto px-4 pt-32 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              ...
              <br />
              <span className="text-gradient-animated">GAINES COUNTY, TX</span>
            </motion.h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-8">
                ...
                <span className="text-gradient">GAINES COUNTY, TEXAS</span>
              </h2>

              <p className="text-lg text-white/70 leading-relaxed mb-6">
                Located in the heart of Texas, Gaines County boasts a rich history and a vibrant community. Established in 1876 and named after James Gaines, a signer of the Texas Declaration of Independence, the county has evolved from cattle ranching to become one of Texas's most productive oil and agricultural regions.
              </p>

              <p className="text-lg text-white/70 leading-relaxed mb-8">
                With Seminole as its county seat and economic center, Gaines County offers residents a strong sense of community and opportunity. The region's economy is driven by oil, cotton, and peanut production. The challenging West Texas climate makes professional insulation essential for both residential and commercial properties.
              </p>

              <div className="glass-orange rounded-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-3">Why Gaines County Needs Quality Insulation</h3>
                <p className="text-white/70 text-sm">
                  Gaines County experiences some of the most extreme temperatures in Texas. Summer highs regularly exceed 100°F while winter nights can plunge well below freezing. Spray foam insulation is your best defense against these harsh conditions.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-zinc-950 relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <span className="text-gradient">GAINES COUNTY</span>
          </motion.h2>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            READY TO GET STARTED IN GAINES COUNTY?
          </motion.h2>
          ...
          >
            Contact Desert Spray Foaming today for a free consultation and quote. We're proud to serve Seminole, Seagraves, and all of Gaines County.
          </motion.p>
