...
export default function YoakumCountyPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/spray-foam-insulation-west-texas.jpg"
            alt="Spray foam insulation in Yoakum County TX"
            fill
        ...
        <div className="container mx-auto px-4 pt-32 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              ...
              <br />
              <span className="text-gradient-animated">YOAKUM COUNTY, TX</span>
            </motion.h1>
            ...
            >
              Your trusted insulation contractor serving Plains, Denver City, and all of Yoakum County. Experience <span className="text-primary-light font-bold">comfort, savings, and quality</span> with Desert Spray Foaming.
            </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-8">
                ...
                <span className="text-gradient">YOAKUM COUNTY, TEXAS</span>
              </h2>

              <p className="text-lg text-white/70 leading-relaxed mb-6">
                Nestled in the heart of Texas, Yoakum County holds a rich tapestry of history and community warmth. Established in 1876 and named after Henderson King Yoakum, a renowned Texas historian and soldier, this county has grown into a vibrant center of industry and agriculture.
              </p>

              <p className="text-lg text-white/70 leading-relaxed mb-8">
                With Plains as its county seat and Denver City as its largest community, Yoakum County offers residents the best of rural Texas living. The region's oil and gas heritage has shaped its economy, while the harsh West Texas climate makes proper insulation a necessity, not a luxury.
              </p>

              <div className="glass-orange rounded-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-3">Why Yoakum County Needs Quality Insulation</h3>
                <p className="text-white/70 text-sm">
                  Yoakum County's high plains location means extreme temperature swings between day and night, plus intense summer heat and bitter winter cold. Spray foam insulation provides the comprehensive thermal protection your property demands.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-20 bg-purple relative">
        <div className="container mx-auto px-4">
          ...
          >
            <span className="text-white">AREAS WE SERVE IN</span>{" "}
            <span className="text-gradient">YOAKUM COUNTY</span>
          </motion.h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {areasServed.map((area, idx) => (
              <motion.div
                ...
                className="px-6 py-3 glass rounded-full border border-white/10"
              >
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            READY TO GET STARTED IN YOAKUM COUNTY?
          </motion.h2>
          ...
          >
            Contact Desert Spray Foaming today for a free consultation and quote. We're proud to serve Plains, Denver City, and all of Yoakum County.
          </motion.p>
