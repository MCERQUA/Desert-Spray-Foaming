...
export default function TerryCountyPage() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Spray foam insulation in Terry County TX"
            fill
        ...
        <div className="container mx-auto px-4 pt-32 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              ...
              <br />
              <span className="text-gradient-animated">TERRY COUNTY, TX</span>
            </motion.h1>
            ...
            >
              Your trusted insulation contractor serving Brownfield and all of Terry County. Experience <span className="text-primary-light font-bold">comfort, savings, and quality</span> with Desert Spray Foaming.
            </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-black mb-8">
                ...
                <span className="text-gradient">TERRY COUNTY, TEXAS</span>
              </h2>

              <p className="text-lg text-white/70 leading-relaxed mb-6">
                Nestled in the heart of Texas, Terry County boasts a rich history and a welcoming community. Established in 1876 and named after Benjamin Franklin Terry, the county has evolved from its agricultural roots into a thriving hub of commerce and culture.
              </p>

              <p className="text-lg text-white/70 leading-relaxed mb-8">
                With Brownfield as its county seat, Terry County offers residents a unique blend of small-town charm and modern amenities. The West Texas climate, with its hot summers and cold winters, makes quality insulation essential for both comfort and energy efficiency.
              </p>

              <div className="glass-orange rounded-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-3">Why Terry County Needs Quality Insulation</h3>
                <p className="text-white/70 text-sm">
                  Terry County experiences extreme temperature variations throughout the year. From scorching summer days to frigid winter nights, spray foam insulation provides the superior thermal barrier your home or business needs.
                </p>
              </div>
            </motion.div>
            ...
            >
              <Image
                src="/images/spray-foam-insulation-brownfield-tx.jpg"
                alt="Spray foam insulation in Brownfield TX"
                fill
                className="object-cover"
              />
      ...
      <section className="py-20 bg-purple relative">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <span className="text-gradient">TERRY COUNTY</span>
          </motion.h2>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            READY TO GET STARTED IN TERRY COUNTY?
          </motion.h2>
          ...
          >
            Contact Desert Spray Foaming today for a free consultation and quote. We're proud to serve Brownfield and all of Terry County.
          </motion.p>
