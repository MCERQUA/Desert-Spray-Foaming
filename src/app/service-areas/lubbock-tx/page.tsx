      ...
      <section className="relative min-h-[80vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-32 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Your trusted insulation contractor serving Lubbock and Lubbock County. Experience <span className="text-primary-light font-bold">comfort, savings, and quality</span> with Desert Spray Foaming.
            </motion.p>
