...
export default function SprayFoamInsulationPage() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-32 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              Experience the cutting-edge benefits of our spray foam solutions. Our advanced technology creates a <span className="text-primary-light font-bold">seamless and energy-efficient barrier</span>, maximizing comfort and lowering costs.
            </motion.p>
      ...
      {/* Benefits Section */}
      <section ref={benefitsRef} className="py-32 bg-gradient-to-b from-purple-dark to-purple relative">
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center font-black text-white">
                      {item.step}
                    </div>
                    <div>
